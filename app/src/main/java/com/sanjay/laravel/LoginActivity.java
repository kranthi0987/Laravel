    ...
    public void logincall(String email, String password, boolean check) {
        ...
        observable.subscribe(new Observer<LoginResponse>() {
            ...
            public void onNext(LoginResponse Listdata) {
                ...
                LoginResponse loginResponse=realm.createObject(LoginResponse.class);
                loginResponse.setAccessToken(Listdata.getAccessToken());
                loginResponse.setTokenType(Listdata.getTokenType());
                loginResponse.setStats(Listdata.getStats());
                loginResponse.setExpiresAt(Listdata.getExpiresAt());
